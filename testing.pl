...
% changed in common.pl, get_solutions predicate). Test by using mutants of the files,
...
% optimal solutions. See the readme file for some reading. 
...
test(sliding3x3) :-
        get_solution('test/Sliding_Puzzle/sliding_domain.pddl', 'test/Sliding_Puzzle/sliding3x3.pddl', X),
        (X =:= 9;
%         print('Sliding3x3 passed'), nl; 
        (nl, print(' ===> '), print('Sliding3x3 failed, expected 9, computed: '), print(X), 
         print(' <==='), nl, nl, fail)), !.
